...
# BACA DATA
# =====================
df = pd.read_excel("DATA_JAMBI.xlsx", sheet_name="Sheet1")
...
# DASHBOARD
# =====================
st.set_page_config(page_title="Dashboard Iklim Jambi", layout="wide")
st.title("🌦️ Dashboard Iklim Provinsi Jambi")
